...
public  class MetaioSDKViewActivity extends ARViewActivity implements MetaioSurfaceView.Callback, View.OnTouchListener
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
        ...
        try
        {
            ...
            metaioSDK = MetaioSDK.CreateMetaioSDKAndroid(this, "Cr948qPBnrHxhEL1qo95dcGlVAP6eTBfqrfS/6g//xM=");
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1)
            {
                mDisplayListener = new DisplayManager.DisplayListener()
                {
                    ...
                    {
                        final ESCREEN_ROTATION rotation = Screen.getRotation(MetaioSDKViewActivity.this);
